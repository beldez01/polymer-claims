...
Synthetic VALUES, real STRUCTURE: 50 cg-format probes x 8 samples (4 case / 4 control) on a
synthetic genomic region (hg38). No RNG — every value is a fixed function of its indices, so the
