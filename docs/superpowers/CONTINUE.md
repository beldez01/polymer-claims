...
## ▶ NEXT: protocol sub-project #3 — SELECT (the pursuit/value engine)
...
3. **SELECT** ← NEXT — the pursuit/value engine (two-axis posterior, EIG, three-axis Pareto, cost model, quality-diversity portfolio + firewalls).
